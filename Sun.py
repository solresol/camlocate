...
class Sun:
    ...
    def sunRiseSet(self, year, month, day, lon, lat, altit=0):
        # Modified for altitude.
	"""
	...
	of the Earth's atmosphere).
	"""
	aadd=self.acosd(6378/(6378+altit)) #Angle offset
	return self.__sunriset__(year, month, day, lon, lat, -35.0/60.0-aadd, 1)
